...
impl Kirchhoff {
    ...
    pub fn first_law(&mut self) -> Vec<EquationK> {
        for node in &self.circuit.nodes {
            ...
            for element in node.elements.clone() {
                match element {
                    crate::kernel::elements::element_type::ElementType::Resistor(mut resistor) => {
                        ...
                        curr_equation.left_side.push(ElementType::Resistor(resistor.clone()));
                        curr_equation_to_paint_left_side.push_str(
                            &format!("{}I_{}",sign,resistor.id)
                        );
                    },
                    crate::kernel::elements::element_type::ElementType::Inductor(mut inductor) => {
                        ...
                        curr_equation.left_side.push(ElementType::Inductor(inductor.clone()));
                        curr_equation_to_paint_left_side.push_str(
                            &format!("{}I_{}",sign,inductor.id)
                        );
                    },
                    crate::kernel::elements::element_type::ElementType::Capacitor(mut capacitor) => {
                        ...
                        curr_equation.left_side.push(ElementType::Capacitor(capacitor.clone()));
                        curr_equation_to_paint_left_side.push_str(
                            &format!("{}I_{}",sign,capacitor.id)
                        );
                    },
                    crate::kernel::elements::element_type::ElementType::VoltageSourceAC(mut voltage_source_ac) => {
                        ...
                        curr_equation.left_side.push(ElementType::VoltageSourceAC(voltage_source_ac.clone()));
                        curr_equation_to_paint_left_side.push_str(
                            &format!("{}I_{}",sign,voltage_source_ac.id)
                        );
                    },
                    crate::kernel::elements::element_type::ElementType::VoltageSourceDC(mut voltage_source_dc) => {
                        ...
                        curr_equation.left_side.push(ElementType::VoltageSourceDC(voltage_source_dc.clone()));
                        curr_equation_to_paint_left_side.push_str(
                            &format!("{}I_{}",sign,voltage_source_dc.id)
                        );
                    },
                    crate::kernel::elements::element_type::ElementType::CurrentSourceAC(mut current_source_ac) => {
                        ...
                        curr_equation.left_side.push(ElementType::CurrentSourceAC(current_source_ac.clone()));
                        curr_equation_to_paint_right_side.push_str(
                            &format!("{}{}",sign,current_source_ac.id)
                        );
                    },
                    crate::kernel::elements::element_type::ElementType::CurrentSourceDC(mut current_source_dc) => {
                        ...
                        curr_equation.left_side.push(ElementType::CurrentSourceDC(current_source_dc.clone()));
                        curr_equation_to_paint_left_side.push_str(
                            &format!("{}{}",sign,current_source_dc.id)
                        );
                    },
            ...
            println!("{}={}",curr_equation_to_paint_left_side,curr_equation_to_paint_right_side);
