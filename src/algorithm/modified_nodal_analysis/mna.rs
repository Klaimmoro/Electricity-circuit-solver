...
use super::entities::{
    equation::Equation,
    expression::{expression::Expression, inductor_exp::InductorExp, resistor_exp::ResistorExp},
};
use crate::{
            ...
            for expression in equation.left_side {
                match expression {
                    ElementType::Resistor(resistor) => {
                        curr_eq.left_side.push(Expression::ResistorExp(ResistorExp {
                            numerator: self
                                .circuit
                                .nodes
                                .iter()
                    ...
                    ElementType::Inductor(inductor) => {
                        ...
                        curr_eq.left_side.push(Expression::InductorExp(InductorExp {
                            numerator: self
                                .circuit
                                .nodes
                                .iter()
                                ...
                                .unwrap()
                                .clone(),
                            denumerator: Complex::new(0.0, omega * inductor.inductance),
                        }));
                        curr_eq.left_side.push(Expression::ResistorExp(ResistorExp {
                            numerator: self
                                .circuit
                    ...
                    ElementType::Capacitor(capacitor) => {
                        ...
                        curr_eq.left_side.push(Expression::ResistorExp(ResistorExp {
                            numerator: self
                                ...
                                .unwrap()
                                .clone(),
                            denumerator: 1.0 / Complex::new(0.0, omega * capacitor.capacitance),
                        }));
                        curr_eq.left_side.push(Expression::ResistorExp(ResistorExp {
                            numerator: self
                                .circuit
